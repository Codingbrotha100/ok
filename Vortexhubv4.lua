...
local StealRemote = RS:WaitForChild("RemoteEvent")
...
local function makeDropdown(parent, labelTxt, options, initIdx, order, onChange)
    ...
    selBtn.TouchTap:Connect(toggleDrop)
end
